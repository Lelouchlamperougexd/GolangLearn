...
const DeveloperDashboardContent: FunctionComponent = () => {
  ...
  const onboardingKey = `qonys_onboarding_developer_${user?.id ?? "anon"}`;
  ...
  const NAV = [
    ...
    { key: "projects",      label: "Проекты",    icon: "/assets/document.svg" },
    { key: "objects",       label: "Объекты",    icon: "/assets/home.svg" },
